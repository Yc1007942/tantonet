...
| **Fleet & network figures** updated to stakeholder-confirmed values (60+ vessels, 33,000+ TEU, 33 ports, 1M+ containers/year), superseding the originally extracted figures, consistently across all pages | `data/content.json`·`fleet.json` (+ regenerated `.js`), all HTML pages, `main.js` journey captions |
